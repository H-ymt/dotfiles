...
# ========================================
# Static git abbreviations
# Ported from zsh-abbr (user-abbreviations)
# ========================================
...
abbr --add gcav 'git commit --verbose --all --amend'
...
abbr --add gcv 'git commit --verbose --amend'
abbr --add gcna 'git commit --verbose --no-edit --amend'
...
# ========================================
# Dynamic branch abbreviations
# (use git_main_branch / git_current_branch / git_develop_branch functions)
# ========================================
